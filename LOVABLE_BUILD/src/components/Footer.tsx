      ...
      <div className="mx-auto max-w-7xl px-6 py-20 grid gap-12 md:grid-cols-5">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-light">
            <li><Link to="/events" className="hover:text-foreground transition-colors">Retreats & workshops</Link></li>
            <li><Link to="/events" className="hover:text-foreground transition-colors">Hire the homestead</Link></li>
            <li><Link to="/events" className="hover:text-foreground transition-colors">Community gatherings</Link></li>
            <li><Link to="/stays" className="hover:text-foreground transition-colors">Bespoke stays</Link></li>
            <li><Link to="/contact" className="hover:text-foreground transition-colors">Enquire</Link></li>
          </ul>
        </div>
