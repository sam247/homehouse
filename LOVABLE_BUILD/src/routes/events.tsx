...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hire the homestead for retreats, workshops, community gatherings and events in the Norfolk countryside." },
      { property: "og:title", content: "Retreats & Events — Home House Homestead" },
      { property: "og:description", content: "Hire the homestead for retreats, workshops and gatherings." },
...
const formats = [
  { name: "Retreats", body: "Whole-house or shared retreats for small groups, with optional catering, sessions and meditation spaces." },
  { name: "Workshops", body: "A bright, quiet space for teaching, movement, sound, writing and creative work." },
  { name: "Gatherings", body: "Family celebrations, milestone moments, ceremonies and community days." },
];
  ...
  return (
    <PageShell>
      ...
      <Zigzag
        ...
        image={IMG.workshop}
        body={<p>Movement, sound, breath, writing — the spaces here invite focus and stillness. We help you set up the room as you need it.</p>}
      />
      ...
      <Zigzag
        ...
        image={IMG.retreat}
        body={<p>Take over the house and land for a few days. We can cater simple, organic meals from the garden, or step back entirely while you self-host.</p>}
      />
      ...
      <Section className="text-center">
        <h2 className="font-serif text-4xl md:text-5xl reveal">
