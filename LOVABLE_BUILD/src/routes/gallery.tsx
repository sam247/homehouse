...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Images of the Norfolk farmhouse, gardens, fields and life at Home House Homestead." },
      { property: "og:title", content: "Gallery — Home House Homestead" },
      { property: "og:description", content: "A glimpse of life at the homestead." },
