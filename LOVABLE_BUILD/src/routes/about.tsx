...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The story behind Home House Homestead: a Norfolk farmhouse dedicated to simple living, nourishment and quiet reconnection." },
      { property: "og:title", content: "About — Home House Homestead" },
      { property: "og:description", content: "A Norfolk farmhouse dedicated to simple living, nourishment and reconnection." },
    ...
    <PageShell>
      ...
      <Zigzag
        ...
        body={
          <>
            <p>
              Hawa Amanda welcomes guests with warmth, simplicity and care. Meals are
              cooked fresh from the homestead garden where possible, and the rhythm of the
              house follows the land.
            </p>
            <p>
              Whether you come to rest, to write, to walk, or to simply pause — you are
              held in a space that listens.
            </p>
          </>
        }
      />
