...
const IMG = {
  ...
  // Former Rose Room gallery: left → Bluebell, middle → Rose, right → Lavender
  bluebellRoom: "/photos/stays/rose_room/5658BF93-B6A4-4716-B7B9-7E19750D254D-IMG_5665.jpeg",
  roseRoom: "/photos/stays/rose_room/D109197E-9FA5-4CC9-BEC7-5F46519F97E1-5d4cfadf-4474-4e86-9ffd-3cf6406a0897.jpeg",
  lavenderRoom: "/photos/stays/rose_room/F8B9A04D-18A8-47AE-BA4D-4EE8844E1525-IMG_5689.jpeg",
};
...
const rooms = [
  ...
  },
  {
    ...
    desc: "A space for wisdom, resilience, and connection to the land. The Bluebell Room can be set as a double or twin.",
  },
];
