        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-16 items-start">
          <div className="md:col-span-2 reveal space-y-10">
            ...
            <div className="space-y-4 text-foreground/80 font-light leading-relaxed">
              <p>
                Ana and Amanda are beyond excited to be bringing you this event.
              </p>
              <p>
              ...
              <p>
                ...
                soundscape of voice and instruments, and the evening song of birds in springtime. If not, we will gather
                inside the warm, intimate space of Home House and be deeply held in soft candlelight.
              </p>
            </div>
            ...
            <div className="reveal space-y-4">
              ...
              <p className="text-foreground/80 font-light leading-relaxed">
                After the journey, you will have a space to ground and connect. You can enjoy the garden and connect to
                the Earth, or share and connect with the other participants. For those who choose to stay on, we will be
                offering a nourishing soup and homemade bread, prepared with love, which you can enjoy around the fire.
              </p>
            </div>
            ...
            <div className="reveal">
              ...
              <p className="mt-6 text-foreground/80 font-light">
                A quiet, powerful collaboration and a space to receive.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="border border-border p-8">
                  ...
                  <div className="text-foreground/80 font-light leading-relaxed space-y-4">
                    <p>
                      Amanda brings a lifelong devotion to music, beginning with classical piano at the age of four and
                      continuing into formal studies in music and voice.
                    </p>
                    <p>
                      After almost two decades away from piano and voice, she rediscovered them through her healing and
                      medicine songs inspired by Native American tradition — songs still sung today in Forrest Yoga
      ...
      <Section className="border-t border-border">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="reveal space-y-6">
            ...
            <div className="text-foreground/80 font-light leading-relaxed space-y-4">
              <p>
                I offer bespoke, in-person retreats for women at Home House, for those who feel called to come and work
                with me more deeply.
              </p>
              <p>
              ...
              <p>
                You are welcome to come alone, or with a sister, friend, or small group. Retreats can be held as quiet,
                restorative stays, or as more guided and immersive healing experiences.
              </p>
            </div>
            <div className="reveal">
