          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20">
            <div className="reveal space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 text-foreground/70 font-light">Full address shared once your stay is confirmed.</p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-accent mb-3">Reply times</p>
                <p className="font-light text-foreground/80">
                  We reply personally, usually within 24 hours. The homestead runs at a slower rhythm — thank you for
                  your patience.
                </p>
              </div>
            </div>
